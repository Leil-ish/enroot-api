...
function makeTasksArray(users, plants) {
  return [
        {id:1,plant_id:plants[7].id,plant_common_name:'Russian Thistle',user_id:users[1].id,maintenance_needed:'pellentesque viverra pede ac diam cras pellentesque volutpat',frequency:'neque',details:'elementum nullam varius nulla facilisi cras non velit nec nisi vulputate nonummy maecenas tincidunt'},
        {id:2,plant_id:plants[9].id,plant_common_name:'Padron\'s Bristle Fern',user_id:users[0].id,maintenance_needed:'at turpis donec posuere metus vitae ipsum aliquam non mauris morbi non lectus aliquam sit amet diam',frequency:'eget',details:'nisi volutpat eleifend donec ut dolor morbi vel lectus in quam fringilla rhoncus mauris enim leo rhoncus sed vestibulum'},
        {id:3,plant_id:plants[12].id,plant_common_name:'Steyermark\'s Milkwort',user_id:users[1].id,maintenance_needed:'luctus et ultrices posuere cubilia curae donec pharetra',frequency:'at diam nam',details:'vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at ipsum ac tellus'},
        {id:4,plant_id:plants[10].id,plant_common_name:'Necklacepod',user_id:users[0].id,maintenance_needed:'libero ut massa volutpat convallis morbi odio odio elementum eu interdum eu tincidunt in',frequency:'et',details:'eleifend quam a odio in hac habitasse platea dictumst maecenas ut massa'},
        {id:5,plant_id:plants[19].id,plant_common_name:'Simple Bog Sedge',user_id:users[1].id,maintenance_needed:'nunc nisl duis bibendum felis sed interdum venenatis turpis enim blandit mi in porttitor pede',frequency:'nulla justo',details:'congue etiam justo etiam pretium iaculis justo in hac habitasse platea dictumst etiam'},
        {id:6,plant_id:plants[2].id,plant_common_name:'Milkmaids',user_id:users[0].id,maintenance_needed:'nisl nunc rhoncus dui vel sem sed sagittis nam congue risus semper',frequency:'morbi a',details:'luctus ultricies eu nibh quisque id justo sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in faucibus'},
        {id:7,plant_id:plants[15].id,plant_common_name:'Sclerocarya',user_id:users[1].id,maintenance_needed:'non pretium quis lectus suspendisse potenti in eleifend',frequency:'cras non velit',details:'sapien urna pretium nisl ut volutpat sapien arcu sed augue aliquam erat volutpat in congue etiam'},
        {id:8,plant_id:plants[4].id,plant_common_name:'Navajo Bridge Pricklypear',user_id:users[0].id,maintenance_needed:'penatibus et magnis dis parturient montes',frequency:'ipsum dolor sit',details:'non mauris morbi non lectus aliquam sit amet diam in magna bibendum imperdiet nullam orci'},
        {id:9,plant_id:plants[18].id,plant_common_name:'Creeping Liriope',user_id:users[1].id,maintenance_needed:'dui vel nisl duis ac nibh fusce lacus purus aliquet at feugiat non pretium quis lectus',frequency:'vivamus vel',details:'in hac habitasse platea dictumst morbi vestibulum velit id pretium iaculis diam erat fermentum justo nec condimentum neque sapien'},
        {id:10,plant_id:plants[14].id,plant_common_name:'Balm-of-gilead',user_id:users[1].id,maintenance_needed:'id ligula suspendisse ornare consequat lectus',frequency:'tristique in',details:'luctus cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus vivamus vestibulum sagittis sapien'},
        {id:11,plant_id:plants[5].id,plant_common_name:'Wright\'s Spotted Felt Lichen',user_id:users[0].id,maintenance_needed:'nisi volutpat eleifend donec ut dolor morbi vel lectus in quam fringilla rhoncus mauris enim leo rhoncus sed',frequency:'aliquam',details:'tristique est et tempus semper est quam pharetra magna ac consequat metus sapien ut nunc vestibulum ante ipsum'},
        {id:12,plant_id:plants[3].id,plant_common_name:'Lesser Bottlebrush',user_id:users[1].id,maintenance_needed:'vestibulum aliquet ultrices erat',frequency:'mattis nibh',details:'habitasse platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum at lorem integer tincidunt ante vel ipsum'},
        {id:13,plant_id:plants[4].id,plant_common_name:'Navajo Bridge Pricklypear',user_id:users[1].id,maintenance_needed:'dolor sit amet consectetuer adipiscing elit proin risus praesent lectus vestibulum quam sapien varius ut',frequency:'eget eleifend luctus',details:'tortor sollicitudin mi sit amet lobortis sapien sapien non mi integer ac neque duis bibendum'},
        {id:14,plant_id:plants[15].id,plant_common_name:'Sclerocarya',user_id:users[0].id,maintenance_needed:'pede posuere nonummy integer non',frequency:'nec condimentum',details:'nisl duis bibendum felis sed interdum venenatis turpis enim blandit mi in porttitor pede justo eu massa'},
        {id:15,plant_id:plants[3].id,plant_common_name:'Lesser Bottlebrush',user_id:users[1].id,maintenance_needed:'nisl venenatis lacinia aenean sit amet',frequency:'convallis morbi odio',details:'justo in hac habitasse platea dictumst etiam faucibus cursus urna ut tellus nulla ut erat id mauris'},
        {id:16,plant_id:plants[4].id,plant_common_name:'Navajo Bridge Pricklypear',user_id:users[0].id,maintenance_needed:'imperdiet nullam orci pede venenatis non sodales sed tincidunt eu felis fusce posuere felis sed lacus morbi sem',frequency:'ipsum primis',details:'lobortis ligula sit amet eleifend pede libero quis orci nullam molestie nibh in lectus pellentesque'},
        {id:17,plant_id:plants[5].id,plant_common_name:'Wright\'s Spotted Felt Lichen',user_id:users[0].id,maintenance_needed:'magnis dis parturient montes nascetur ridiculus mus vivamus vestibulum sagittis sapien',frequency:'nulla suscipit',details:'in purus eu magna vulputate luctus cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus vivamus'},
        {id:18,plant_id:plants[9].id,plant_common_name:'Padron\'s Bristle Fern',user_id:users[0].id,maintenance_needed:'convallis nunc proin at turpis a pede posuere nonummy integer non velit donec diam',frequency:'eu',details:'integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel augue vestibulum ante ipsum primis in faucibus'},
        {id:19,plant_id:plants[8].id,plant_common_name:'Arrowfeather Threeawn',user_id:users[1].id,maintenance_needed:'orci nullam molestie nibh in',frequency:'aliquet',details:'suspendisse potenti in eleifend quam a odio in hac habitasse platea dictumst maecenas ut massa quis augue'},
        {id:20,plant_id:plants[19].id,plant_common_name:'Simple Bog Sedge',user_id:users[1].id,maintenance_needed:'vel enim sit amet nunc',frequency:'nulla ac enim',details:'diam vitae quam suspendisse potenti nullam porttitor lacus at turpis donec posuere metus vitae ipsum aliquam non mauris morbi'}
    ]
}
...
function makeExpectedPlant(plant) {
  ...
  function makeExpectedPlantTasks(plantId, tasks) {
    const expectedTasks = tasks.filter(task => task.plant_id === plantId)
